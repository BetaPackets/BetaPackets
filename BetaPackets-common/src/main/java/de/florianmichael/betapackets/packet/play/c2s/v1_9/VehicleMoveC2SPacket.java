...
public class VehicleMoveC2SPacket extends Packet {
    ...
    public VehicleMoveC2SPacket(final FunctionalByteBuf buf) {
        this(buf.readDouble(), buf.readDouble(), buf.readDouble(), buf.readFloat(), buf.readFloat());
    }

    public VehicleMoveC2SPacket(double x, double y, double z, float yaw, float pitch) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.yaw = yaw;
    ...
    public boolean equals(Object o) {
        ...
        VehicleMoveC2SPacket that = (VehicleMoveC2SPacket) o;
