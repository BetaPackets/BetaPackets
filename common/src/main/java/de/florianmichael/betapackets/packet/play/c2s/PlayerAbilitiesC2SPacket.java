...
public class PlayerAbilitiesC2SPacket extends Packet {

    public byte flags;
    public float flyingSpeed;
    public float walkingSpeed;

    public PlayerAbilitiesC2SPacket(final FunctionalByteBuf buf) {
        this(
                buf.readByte(),
    ...
    public PlayerAbilitiesC2SPacket(byte flags, float flyingSpeed, float walkingSpeed) {
        this.flags = flags;
    ...
    public String toString() {
        return "PlayerAbilitiesC2SPacket{" +
                "flags=" + flags +
    ...
    public boolean equals(Object o) {
        ...
        PlayerAbilitiesC2SPacket that = (PlayerAbilitiesC2SPacket) o;
