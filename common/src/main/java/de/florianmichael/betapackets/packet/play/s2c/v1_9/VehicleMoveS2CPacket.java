...
public class VehicleMoveS2CPacket extends Packet {
    ...
    public VehicleMoveS2CPacket(final FunctionalByteBuf buf) {
        this(buf.readDouble(), buf.readDouble(), buf.readDouble(), buf.readFloat(), buf.readFloat());
    }

    public VehicleMoveS2CPacket(double x, double y, double z, float yaw, float pitch) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.yaw = yaw;
    ...
    public boolean equals(Object o) {
        ...
        VehicleMoveS2CPacket that = (VehicleMoveS2CPacket) o;
